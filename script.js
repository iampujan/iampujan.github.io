document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            hero_subtitle: 'I design and deploy intelligent systems, build scalable data pipelines, and develop robust Python backends. Passionate about transforming complex data into actionable insights and creating AI-driven solutions that are both powerful and efficient.',
        ...
        it: {
            ...
            hero_subtitle: 'Progetto e implemento sistemi intelligenti, costruisco pipeline di dati scalabili e sviluppo backend Python robusti. Sono appassionato di trasformare dati complessi in informazioni fruibili e di creare soluzioni basate sull'/'intelligenza artificiale potenti ed efficienti.',
        ...
        ne: {
            ...
            hero_subtitle: 'म बुद्धिमान प्रणालीहरू डिजाइन र तैनाथ गर्छु, स्केलेबल डेटा पाइपलाइनहरू निर्माण गर्छु, र बलियो पाइथन ब्याकएन्डहरू विकास गर्छु। जटिल डेटालाई कार्ययोग्य अन्तर्दृष्टिमा रूपान्तरण गर्ने र शक्तिशाली र कुशल दुवै प्रकारका एआई-संचालित समाधानहरू सिर्जना गर्ने बारे उत्साहित छु।',
